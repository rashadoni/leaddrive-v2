...
| WF-C5-004 | P0 | PARTIAL | Backend/Security | Validate Android Key Attestation chain, roots, revocation, security level, challenge and app identity server-side | [`attestation verifier foundation`](./workforce-c5-android-key-attestation-foundation-evidence-2026-08-30.md) and [`server-first preflight`](./workforce-c5-attestation-preflight-evidence-2026-08-31.md): fail-closed chain/root/revocation/key/claim gate plus server-first HMAC-only KeyStore nonce exist; official verifier integration, live status feed, endpoint consumption and physical evidence remain open |
