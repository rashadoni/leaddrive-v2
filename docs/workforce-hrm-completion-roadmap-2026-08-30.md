...
| WF-C6-005 | P1 | PARTIAL | Web | Build exception queue with scope, risk, age, evidence completeness, employee response and next action | [`workforce-c6-exception-queue-foundation-evidence-2026-08-30.md`](./workforce-c6-exception-queue-foundation-evidence-2026-08-30.md): raw-proof-free projected review fields and human next action fail closed; scoped query, UI and real resolution remain open |
| WF-C6-006 | P1 | PARTIAL | Web/Mobile | Let employee explain or appeal an exception and request a correction from the exact day/segment | [`workforce-c6-employee-response-foundation-evidence-2026-08-30.md`](./workforce-c6-employee-response-foundation-evidence-2026-08-30.md): employee web path safely requests correction from own exact workday and sees request status; C6 case/segment appeal lifecycle and mobile remain open |
