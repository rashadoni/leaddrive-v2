...
| 2026-09-13T07:21:00+02:00 | C11 site-transition report projection (partial) | 86% | C11 50% | 139/161 | 14/15 | WF-C11-007 gains a bounded, raw-proof-free transition-claim projection with pair/incomplete/review reconciliation; API, historical scope and UI remain open, so no completion credit is claimed |
...
| WF-C11-007 | P1 | PARTIAL | Web/Analytics | Add schedule/actual, late, no-show, overtime, break, site-transition and exception reports with scope/date filters | [`approved-time report evidence`](./workforce-c11-approved-report-evidence-2026-08-30.md) and [`site-transition projection evidence`](./workforce-c11-site-transition-report-foundation-evidence-2026-09-13.md): immutable schedule/actual/deviation reporting and a bounded transition projection exist; transition API/UI and remaining lifecycle evidence stay open |
