...
| WF-C9-007 | P0 | PARTIAL | Mobile | Implement permission-aware action-time location capture and approved on-duty transition mode; stop at Finish/off-shift | [`workforce-c9-android-foundation-evidence-2026-08-30.md`](./workforce-c9-android-foundation-evidence-2026-08-30.md): foreground-only current-location primitive is source-gated from activation; legal/policy/action-binding and physical background/permission/battery evidence remain open |
