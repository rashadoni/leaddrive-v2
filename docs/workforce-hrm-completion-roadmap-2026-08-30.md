...
| WF-C11-007 | P1 | PARTIAL | Web/Analytics | Add schedule/actual, late, no-show, overtime, break, site-transition and exception reports with scope/date filters | [`workforce-c11-approved-report-evidence-2026-08-30.md`](./workforce-c11-approved-report-evidence-2026-08-30.md): scoped immutable schedule/actual/late/overtime/break aggregate and correction deduplication exist; no-show/site-transition/full exception lanes await C2/C6 lifecycle evidence |
