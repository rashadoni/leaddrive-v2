...
- **CTA (кадр 7): «Demo sorğusu»** — дословно кнопка leaddrivecrm.org. Триала
  «сам включил» на сайте нет, есть только согласуемый пилот, поэтому «Pulsuz
  sınaq» не обещаем.
- **Instagram / Facebook убраны** из кадра 6, из озвучки и из финальной карточки,
  пока живые DM ждут App Review Meta. Кадр 6 теперь: WhatsApp · Telegram · TikTok
  · SMS · E-poçt · Veb-çat · VoIP.
