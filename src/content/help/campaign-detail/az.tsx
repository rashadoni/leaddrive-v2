      ...
      <HelpSection title="Addım-addım: kampaniyanı yaz və göndər (Yazmaq tabı)">
        ...
        <HelpStep n={4}>
          ...
          <HelpCallout kind="see" label="Ekranda görəcəksiniz">
            ...
            statusu <strong>Planlaşdırılıb</strong> olur. Tarix yalnız plandır: həmin vaxt kampaniya
            özü göndərilmir — göndərmək üçün səhifənin yuxarısındakı <HelpKey>Kampaniyanı göndər</HelpKey>{" "}
            düyməsini basın.
          </HelpCallout>
        </HelpStep>
      </HelpSection>
