    ...
    <div className="space-y-6">
      ...
      <HelpSection title="The Analytics tab">
        ...
        <HelpCallout kind="see" label="What you'll see">
          ...
          deal is linked to a campaign — the card shows «—» and the reason. ROI is the same figure as
          on the Campaign ROI page: a number only when the won deals and the budgets of sent
          campaigns are in one currency. “Top campaigns” are ranked
