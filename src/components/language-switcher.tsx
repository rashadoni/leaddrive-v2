  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && typeof document !== "undefined" && createPortal(
        <div
          ref={dropdownRef}
          className="fixed z-[9999] min-w-[140px] rounded-md border border-zinc-200 dark:border-zinc-700 bg-popover shadow-lg animate-in fade-in slide-in-from-top-1 duration-150"
