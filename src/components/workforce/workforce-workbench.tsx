...
type WorkforceRequest = {
  ...
  /** Per-record C7 decision fence; fall back only for older server payloads. */
  canDecide?: boolean
  /** Exact self-only cancellation fence; fall back only for older server payloads. */
  canCancelSelf?: boolean
}
