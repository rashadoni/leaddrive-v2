...
const DELIVER =
  /withRls(?:<[^>]+>)?\(|withRlsAuth(?:<[^>]+>)?\(|withRlsSessionAuth(?:<[^>]+>)?\(|withInboxSessionWrite(?:<[^>]+>)?\(|withSocialMonitoringMutationFence(?:<[^>]+>)?\(|withSocialConnectAuth\(|withMobileRls(?:<[^>]+>)?\(|withMobileFieldSuiteRls(?:<[^>]+>)?\(|withMobileTenantCapabilityRls(?:<[^>]+>)?\(|withMtmRlsAuth(?:<[^>]+>)?\(|withRouteFieldRlsAuth(?:<[^>]+>)?\(|withRouteFieldWebRlsAuth(?:<[^>]+>)?\(|withWorkforceHrmRlsAuth(?:<[^>]+>)?\(|withWorkforceRlsAuth(?:<[^>]+>)?\(|withWorkforceSessionAuth(?:<[^>]+>)?\(|withWorkforceSessionAdminAuth(?:<[^>]+>)?\(|withWorkforceSessionGrantManagementAuth(?:<[^>]+>)?\(|withWorkforceSessionEvidenceTimelineAuth(?:<[^>]+>)?\(|withWorkforceSessionExceptionDecisionAuth(?:<[^>]+>)?\(|withWorkforceSessionExceptionQueueAuth(?:<[^>]+>)?\(|withWorkforceSessionPolicyConfigurationAuth(?:<[^>]+>)?\(|withWorkforceSessionPilotFenceAuth(?:<[^>]+>)?\(|withWorkforceSessionRetentionReadAuth(?:<[^>]+>)?\(|withWorkforceSessionScheduleConfigurationAuth(?:<[^>]+>)?\(|withWorkforceCompatAuth(?:<[^>]+>)?\(|runWithTenant|runWithRlsBypass/
