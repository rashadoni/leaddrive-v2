-- RLS rollout — HOT (highest-traffic) tranche: enable Postgres Row-Level Security on "deals".
...
--   ALTER TABLE "deals" DISABLE ROW LEVEL SECURITY;   -- or
--   DROP POLICY tenant_isolation ON "deals";
--
