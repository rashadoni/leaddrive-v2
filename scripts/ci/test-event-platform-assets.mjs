...
for (const requiredWorkflowGuard of [
  ...
  "group: production-deploy",
  "cancel-in-progress: false",
  'EXPECTED_CONFIRMATION="CONFIGURE_BACKUP_MONITORING_ON_13_140_132_245"',
  ...
  "Stage dead-man monitoring URLs without logging them",
  "secrets.BACKUP_HEALTHCHECK_URL",
  "secrets.SECRETS_HEALTHCHECK_URL",
  "secrets.RUNTIME_FILES_HEALTHCHECK_URL",
  "secrets.LOG_SHIP_HEALTHCHECK_URL",
  '"$REMOTE_STAGE_DIR/healthchecks.env"',
