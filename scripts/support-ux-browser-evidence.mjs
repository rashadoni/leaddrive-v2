...
const scenarios = [
  ...
  { id: "complaints", path: "/complaints", roles: ["manager", "admin"], primaryClicks: 1, filter: true, ready: "[data-testid='complaints-workspace']", primary: "tbody tr[tabindex='0'], article, [data-testid='complaints-empty-state']", performanceBudget: { loadP75: 650 } },
  { id: "complaint-new", path: "/complaints/new", roles: ["manager", "admin"], primaryClicks: 1, ready: "[data-testid='complaint-new-workspace']", primary: "[data-testid='complaint-new-form']", performanceBudget: { loadP75: 450 } },
